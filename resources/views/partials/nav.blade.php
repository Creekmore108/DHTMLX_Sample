        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                     ...
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="{{ url('/allschedules') }}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            {!! trans('titles.schedulesDropdownNav') !!}
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">

                            <a class="dropdown-item" href="{{ url('/myschedule') }}">
                                {!! trans('titles.mySchedule') !!}
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ url('/allschedules') }}">
                                {!! trans('titles.allSchedules') !!}
                            </a>
                            <div class="dropdown-divider"></div>
